#!/usr/bin/env python3
"""
Process Workflows for Aerosim Utils
...
for folder in [DEFAULT_OUTPUT_DIR, DEFAULT_TRACKS_DIR, DEFAULT_TRAJECTORIES_DIR, DEFAULT_VISUALIZATION_DIR, DEFAULT_FOLIUM_DIR]:
