...
The `fmu_aux_input_mapping` and `fmu_aux_output_mapping` fields can be used to map FMU input/output variables that do not conform to an existing message type to specific parameters if needed. 
